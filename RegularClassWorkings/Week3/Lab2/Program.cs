...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine($"Book 1 created. Total books so far: {LibraryBook.TotalBooksCreated}");

        LibraryBook book2 = new LibraryBook("OOP", "ISBN002");
        Console.WriteLine($"Book 2 created. Total books so far: {LibraryBook.TotalBooksCreated}");

        LibraryBook book3 = new LibraryBook("Advanced C#", "ISBN003");
        Console.WriteLine($"Book 3 created. Total books so far: {LibraryBook.TotalBooksCreated}");

        ReferenceBook referenceBook = new ReferenceBook("Reference C#", "ISBN004");
